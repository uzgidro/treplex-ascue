...
$this->title = 'Хонобод МГЭС';

$id = 60;
$urlAggregate1 = Informations::findOne(['id_organization' => $id, 'aggregate' => 1]) !== null ? Url::to(["site/information?id_organization={$id}&&aggregate=1"]) : '#';
$urlAggregate2 = Informations::findOne(['id_organization' => $id, 'aggregate' => 2]) !== null ? Url::to(["site/information?id_organization={$id}&&aggregate=2"]) : '#';
