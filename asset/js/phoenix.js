(function(global, factory) {
      ...
      const handleTooltipPosition = ([e,,t,,o]) => {
            if (window.innerWidth <= 540) {
              ...
              return a[e[0] < o.viewSize[0] / 2 ? "left" : "right"] = 5,
                  a
            }
            return null
          }
            ...
            u.length && u.forEach((o => {
                  ...
                  w.on(a, ( () => {
                        o.querySelector(t) && o.querySelector(t).classList.remove(l),
                            o.classList.add(i),
                            document.querySelector(".kanban-custom-bg-radio").setAttribute("checked", !0);
                      }
                  )),
                      w.on(c, ( () => {
                          ...
                          const r = e(o, s)
                              ...
                              , m = (e=4) => {
                                for (let t = 1; t < e; t += 1) {
                                  ...
                                  e.classList.add("gallery-column-separator", `gallery-column-separator-${t}`),
                                      o.appendChild(e);
                                }
                              }
                          ;
                          i && m();
                          return document.querySelector(a)?.addEventListener("click", (e => {
                    ...
                    g.on("searchStart", ( () => {
                        ...
                        g.on("updated", (e => {
                              m = g.matchingItems.length ? Math.ceil(g.matchingItems.length / g.page) : Math.ceil(g.size() / g.page),
                                  b = (p - 1) * Number(g.page) + g.visibleItems.length,
                                  v(),
                              y && (p = 0 === g.matchingItems.length ? 0 : 1,
      ...
      const swiperInit = () => {
            ...
            t && t.forEach((t => {
                  ...
                  document.querySelector(".swiper-slider-gallery") && window.addEventListener("resize", ( () => {
                        s.update();
                      }
                  ));
                }
      ...
      const {config: config} = window.config
          , initialDomSetup = e => {
            ...
            e && e.querySelectorAll("[data-theme-control]").forEach((e => {
                  const r = t(e, "theme-control")
                      , n = a(r);
                  "phoenixNavbarTopShape" === r && "dual-nav" === a("phoenixNavbarPosition") && e.setAttribute("disabled", !0);
                  const c = a("phoenixNavbarPosition");
                  if ("phoenixNavbarVerticalStyle" === r && ("horizontal" === c || "dual-nav" === c) && e.setAttribute("disabled", !0),
                  "checkbox" === e.type)
                    "phoenixTheme" === r ? ("auto" === n ? "dark" === o() : "dark" === n) && e.setAttribute("checked", !0) : n && e.setAttribute("checked", !0);
                  else if ("radio" === e.type && "phoenixNavbarVerticalStyle" === r)
                    "darker" === n && "darker" === e.value && e.setAttribute("checked", !0),
                    "default" === n && "default" === e.value && e.setAttribute("checked", !0);
                  else if ("radio" === e.type && "phoenixNavbarTopShape" === r)
                    "slim" === n && "slim" === e.value && e.setAttribute("checked", !0),
                    "default" === n && "default" === e.value && e.setAttribute("checked", !0);
                  else if ("radio" === e.type && "phoenixNavbarTopStyle" === r)
                    "darker" === n && "darker" === e.value && e.setAttribute("checked", !0),
                    "default" === n && "default" === e.value && e.setAttribute("checked", !0);
                  else if ("radio" === e.type && "phoenixTheme" === r) {
                    n === e.value && e.setAttribute("checked", !0);
                  } else if ("radio" === e.type && "phoenixNavbarPosition" === r) {
                    n === e.value && e.setAttribute("checked", !0);
                  } else {
                    n === e.value && e.classList.add("active");
                  }
                }
            ));
          }
          , changeTheme = e => {
            ...
            e.querySelectorAll('[data-theme-control = "phoenixTheme"]').forEach((e => {
                  const r = t(e, "theme-control")
                      , n = a(r);
                  "checkbox" === e.type ? "auto" === n ? "dark" === o() ? e.checked = !0 : e.checked = !1 : e.checked = "dark" === n : "radio" === e.type ? n === e.value ? e.checked = !0 : e.checked = !1 : n === e.value ? e.classList.add("active") : e.classList.remove("active");
                }
            ));
          }
      ...
      const themeControl = () => {
            const {getData: e, getItemFromStore: t, getSystemTheme: a} = window.phoenix.utils
              ...
              a ? window.location.replace(a) : window.location.reload();
                ...
                , r = new DomNode(document.body)
                , n = document.querySelector(".navbar-vertical")
                , c = document.querySelector(".navbar-top")
                , i = document.querySelector(".support-chat-container");
            initialDomSetup(r.node),
                r.on("click", (e => {
                      ...
                      if (d.data("theme-control")) {
                        ...
                        switch ("phoenixTheme" === l && "boolean" == typeof h && (h = h ? "dark" : "light"),
                        config.hasOwnProperty(l) && window.config.set({
                          ...
                          case "phoenixNavbarVerticalStyle":
                            n.setAttribute("data-navbar-appearance", "default"),
                            "default" !== h && n.setAttribute("data-navbar-appearance", "darker");
                            break;
                          case "phoenixNavbarTopStyle":
                            c.setAttribute("data-navbar-appearance", "default"),
                            "default" !== h && c.setAttribute("data-navbar-appearance", "darker");
                            break;
                ...
                r.on("clickControl", ( ({detail: {control: e, value: t}}) => {
      ...
      const wizardInit = () => {
            ...
            document.querySelectorAll(t).forEach((t => {
                  ...
                  let E = 0
                      , q = null;
                  h.forEach((e => {
                        e.addEventListener(i, (t => (t.preventDefault(),
                            e.classList.contains("needs-validation") && (m && v && (m.value !== v.value ? v.setCustomValidity("Invalid field.") : v.setCustomValidity("")),
                                !e.checkValidity()) ? (q.preventDefault(),
                                !1) : (E += 1,
                                null))));
                      }
                  )),
                  ...
                  b.length && b.forEach(( (t, a) => {
                        t.addEventListener(c, (a => {
                              ...
                              q = a,
                              d > E && h[E].dispatchEvent(y);
                            }
                        )),
                            t.addEventListener(u, ( () => {
                                  E = a,
                                  E !== b.length - 1 || z || b.forEach((e => {
                                  ...
                                  E > b.length - 2 ? L.classList.add("d-none") : L.classList.remove("d-none"),
                                  p && (E > 0 && E !== b.length - 1 ? p.classList.remove("d-none") : p.classList.add("d-none"));
                                }
                            ));
                      }
                  ));
            ...
            if (e) {
              ...
              t.forEach(( (r, u) => {
                    r.addEventListener("keyup", (r => {
                          ...
                          i ? [...i].slice(0, e).forEach(( (e, o) => {
                                t && t[u + o] && (t[u + o].value = e,
                                    t[u + o + 1]?.focus());
                              }
                          )) : (t[u].value = "",
                              t[u - 1]?.focus());
      ...
      const mapboxInit = () => {
        ...
        o && o.forEach((o => {
              ...
              if (n) {
                ...
                }).setLngLat(o.center).addTo(m),
                r && a && (r.addEventListener("click", ( () => m.zoomIn())),
      ...
      themeController$2 && themeController$2.addEventListener("clickControl", ( () => {
            mapboxInit();
          }
      ));
      ...
      const flightMapInit = () => {
        if (document.querySelector("#flightMap")) {
          ...
          e.addEventListener("click", ( () => n.zoomIn())),
              ...
              o.addEventListener("click", ( () => n.getContainer().requestFullscreen()));
            ...
            features: [{
              ...
              geometry: {
                ...
                t.className = `marker-${d}`,
                    new window.mapboxgl.Marker(t).setLngLat(e.geometry.coordinates).addTo(n),
                    d += 1;
              }
          ));
      ...
      const priceTierFormInit = () => {
            ...
            e && e.forEach((e => {
                  ...
                  t.addEventListener("change", (t => {
                        r[0].checked = !0,
                            t.target.checked ? e.classList.add("active") : (e.classList.remove("active"),
                                c.hide());
                      }
                  )),
                      r.forEach((e => {
                    ...
                    e.addSource("earthquakes", {
                      ...
                      clusterRadius: 50
                        ...
                        e.addLayer({
                          ...
                          paint: {
                            "circle-color": ["step", ["get", "point_count"], getColor("secondary"), 100, getColor("info"), 750, getColor("warning")],
      ...
      const passwordToggleInit = () => {
            ...
            t && t.forEach((t => {
                  ...
                  e.addEventListener("click", ( () => {
                        "password" === s.type ? (s.setAttribute("type", "text"),
                            e.classList.add("show-password")) : (s.setAttribute("type", "password"),
