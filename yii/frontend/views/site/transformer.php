...
$model->errors;
$transformer = TransformerName::findOne($model->id_tansformer);
...
?>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-3">
            ...
            <li class="breadcrumb-item active" aria-current="page"><?= $transformer['name'] ?></li>
        </ol>
    </nav>
            ...
            <div class="col-12">
                <div class="row align-items-center justify-content-between g-3 mb-3">
                    <div class="col-12 col-md-auto">
                        <h4 class="mb-0"><?= Html::encode($this->title. " / ".$transformer['name']) ?></h4>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center g-3 text-center text-xxl-start">
                                        <div class="col-12 col-xxl-auto">
                                            <img class="img-fluid h-100" src="<?= Url::to(['upload/transformer/'.$model->photo]) ?>" alt="<?= $model->photo ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="scrollspy-example rounded-2" data-bs-spy="scroll">
                            <div class="mb-8" style="backdrop-filter: blur(5px);">
                                ...
                                <table class="table table-hover table-sm">
                                    ...
                                    <tr>
                                        <td>Мощность</td>
                                        <td><?= $model->power ?> кВа</td>
                                    </tr>
                                    <tr>
                                        <td>Напряжение</td>
                                        <td><?= $model->voltage ?> кВ</td>
                                    </tr>
                                    <tr>
                                        <td>Потерия холостого хода</td>
                                        <td><?= $model->loss_of_idle_speed ?> кВт</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $model->winding_connection ?></td>
                                    </tr>
                                    <tr>
                                        <td>Полная масса</td>
