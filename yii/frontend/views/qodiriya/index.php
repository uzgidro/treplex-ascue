...
$this->title = '"Қодирия ГЭСлар каскади" Филиалида электр энергия ишлаб чиқарилиши';

$dashboard = new Dashboard();
$power = new Day();

$array = [33, 34, 35, 36, 76];
...
<div class="row g-3 list mb-3">
    <div class="col-6 col-xl-6">
        <div class="row g-3 list">
            <div class="col-6 col-xl-6">
                <?= $dashboard->Ges([33], 'ges15', 15) ?>
            </div>
            <div class="col-6 col-xl-6">
                <?= $dashboard->Ges([34], 'ges11', 11) ?>
            </div>
            <div class="col-6 col-xl-6">
                <?= $dashboard->Ges([35], 'ges3', 3) ?>
            </div>
            <div class="col-6 col-xl-6">
                <?= $dashboard->Ges([36], 'ges12', 12) ?>
            </div>
        </div>
    </div>
    <div class="col-6 col-xl-6">
        <?= $dashboard->AllResultGes(3) ?>
    </div>
    <div class="col-3 col-xl-3">
        <?= $dashboard->Ges([76], 'ges3a', "3a") ?>
    </div>
    <div class="col-9 col-xl-9">
        <div class="card" style="backdrop-filter: blur(5px);">
            <div class="card-body">
                <div class="row g-1 g-sm-3 lh-1">
                    <canvas id="myLineChart" width="1100" height="220"></canvas>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    ?>
    const data15 = <?= $dashboard->YesterdayHourGes(33) ?>;
    const data11 = <?= $dashboard->YesterdayHourGes(34) ?>;
    const data3 = <?= $dashboard->YesterdayHourGes(35) ?>;
    const data12 = <?= $dashboard->YesterdayHourGes(36) ?>;
    const data3a = <?= $dashboard->YesterdayHourGes(76) ?>;
            ...
            .then(text => {
                ...
                data.forEach(item => {
                    if(item.id === 1) {
                        ...
                        const value = document.getElementById("active3a");
                        value.textContent = formatNumber(item.value, 2, ',', ' ') + " МВт";
                    } else if(item.id === 27) {
                        const value = document.getElementById("true3a");
                        value.textContent = item.value;
                    } else if(item.id === 28) {
                        const value = document.getElementById("false3a");
                        value.textContent = item.value;
                    } else if(item.id === 29) {
                        const value = document.getElementById("error3a");
                        value.textContent = item.value;
                    }
                })
