...
$this->title = '"Шахрихон ГЭСлар каскади" Филиалида электр энергия ишлаб чиқарилиши';

$dashboard = new Dashboard();
$power = new Day();
$array = [61, 63, 64, 65, 66];
...
<div class="row g-3 list mb-3">
    <div class="col-6 col-xl-6">
        <div class="row g-3 list">
            <div class="col-6 col-xl-6">
                <?= $dashboard->Ges([63], 'ges5', 5) ?>
            </div>
            <div class="col-6 col-xl-6">
                <?= $dashboard->Ges([64], 'ges6', 6) ?>
            </div>
            <div class="col-6 col-xl-6">
                <?= $dashboard->Ges([65], 'jfk1', 1) ?>
            </div>
            <div class="col-6 col-xl-6">
                <?= $dashboard->Ges([66], 'jfk2', 2) ?>
            </div>

        </div>
    </div>
    <div class="col-6 col-xl-6">
        <?= $dashboard->AllResultGes(13) ?>
        ...
        <script>
            ...
            ?>
            const data6 = <?= $dashboard->YesterdayHourGes(64) ?>;
            const data5 = <?= $dashboard->YesterdayHourGes(63) ?>;
            const dataJfk1 = <?= $dashboard->YesterdayHourGes(65) ?>;
            const dataJfk2 = <?= $dashboard->YesterdayHourGes(66) ?>;
