...
$this->title = '"КФК КГЭСлар каскади" Филиалида электр энергия ишлаб чиқарилиши';
    ...
    <div class="col-12 col-xl-12">
        <div class="row g-3 list">
            <div class="col-4 col-xl-4">
                <?= $dashboard->Ges([67, 68], 'ges9', 9) ?>
            </div>
            <div class="col-4 col-xl-4">
                <?= $dashboard->Ges([69], 'chortoq', 'chortoq') ?>
            </div>
            <div class="col-4 col-xl-4">
                <?= $dashboard->Ges([70], 'yangiariq', 'yangiariq') ?>
            </div>
        </div>
    </div>
        ...
        <div class="card" style="backdrop-filter: blur(5px);">
            <div class="card-body">
                <div class="row g-1 g-sm-3 lh-1">
                    <canvas id="myLineChart" width="1100" height="490"></canvas>
                </div>
            </div>
        </div>
    </div>
    <div class="col-7 col-xl-7">
        <?= $dashboard->AllResultGes(22) ?>
    </div>
</div>
<div class="card" style="backdrop-filter: blur(5px);">
    <div class="card-body">
...
<script>
    ...
    ?>
    const data9 = <?= $dashboard->YesterdayHourGes(68) ?>;
    const data8 = <?= $dashboard->YesterdayHourGes(67) ?>;
...
<script>
    ...
    function getServer() {
        ...
        fetch('/kfk/server', { signal: controller.signal })
            .then(response => {
                if (!response.ok) {
